...
def topology():
    ...
    info('*** Adding P4APs\n')
    ap1 = net.addAccessPoint('ap1', cls=P4AP, json_path='build/echo_server.json', runtime_json_path='runtime/ap1-runtime.json', 
			     log_console = True, log_dir = os.path.abspath('logs'), log_file = 'ap1.log', pcap_dump = os.path.abspath('pcaps'))
    ap2 = net.addAccessPoint('ap2', cls=P4AP, json_path='build/echo_server.json', runtime_json_path='runtime/ap2-runtime.json', 
